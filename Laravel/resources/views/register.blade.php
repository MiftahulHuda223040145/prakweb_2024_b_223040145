        ...
        <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="username" name="username" type="name" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                    </div>
                </div>
                <div>
