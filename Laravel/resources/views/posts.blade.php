<x-layout>
    ...
    {{-- <article class="py-8 max-w-screen-md border-b border-gray-300">
        ...
        <div class="text-base">
            ...
            in 
            <a href="/categories/{{$post->category->slug}}" class="hover:underline text-gray-500">{{$post ->category->name}}</a>
        ...
        <a href="/posts/{{ $post ['slug'] }}" class="font-medium text-blue-500 hover-underline">read more &raquo;</a>
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <p class="font-light text-gray-500 dark:text-gray-400">{!! Str::limit($post->body), 150 !!}</p>
                <div class="mt-5 flex justify-between items-center">
                    ...
                    <a href="/posts/{{ $post->slug }}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline text-xs">
                        Read more
