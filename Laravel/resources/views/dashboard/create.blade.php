<x-dashboard.layout>
    ...
    <form class="max-w-sm mx-auto mt-8" method="POST" action="/dashboard/posts" enctype="multipart/form-data">
        ...
        @enderror
        ">Title</label>
        <input type="title" id="title" name="title" required autofocus value="{{ old('title') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 mb-5
        @error('title')
        ...
        @enderror
        ">slug</label>
        <input type="slug" id="slug" name="slug" required value="{{ old('slug') }}" class="mb-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500
        @error('slug')
